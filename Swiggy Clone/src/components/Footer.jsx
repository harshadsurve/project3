...
const place=[
  ...
  return (
    <footer className='flex justify-around bg-slate-100'>
...
<div className='mt-3 font-normal text-slate-800'>
© 2024 Bundl Technologies Pvt. Ltd
</div>
        </div>
        <div className='mt-[50px] mr-[100px] list-none '>
          <h2 className='font-bold mb-3'>Company</h2>
        {
              Company.map((link, index) => (
                 <li key={index} className='hover:text-[#fc8019] cursor-pointer m-2 items-center gap-2'>
                 {link.name}
                 </li>
              ))
              }
...
<h2 className='font-bold mt-8'>Legal</h2>
        {
        ...
        <div className='mt-[50px] mr-[100px] list-none '>
        <h2 className='font-bold mb-3'>We deliver to:</h2>
        {
              ...
              <button className='border p-1 bg-slate-100 w-[120px] border-black mb-4 hover:text-[#fc8019] cursor-pointer'>585 Cities <IoIosArrowDown className='inline pl-2 font-bold text-[30px]'/>
              </button>
        </div>
